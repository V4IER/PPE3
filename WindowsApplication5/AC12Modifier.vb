Public Class AC12Modifier
    ...
    Private Sub AC12Modifier_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        'TODO: cette ligne de code charge les données dans la table 'DataSet1.AC12ETP'. Vous pouvez la déplacer ou la supprimer selon vos besoins.
        Me.AC12ETPTableAdapter.Fill(Me.DataSet1.AC12ETP)

    End Sub

    Private Sub AC12titile_Click(sender As System.Object, e As System.EventArgs) Handles AC12titile.Click
