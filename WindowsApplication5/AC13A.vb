Public Class AC13A
    ...
    Private Sub AC13_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Me.AC13A_ComboBox_Lieu.DataSource = donnee1
        Me.AC13A_ComboBox_Lieu.DisplayMember = "LIEUNOM"
        Me.AC13A_ComboBox_Lieu.ValueMember = "LIEUID"

    End Sub

    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles AC13A_Button_Annuler.Click
        AC12Modifier.Show()
        Me.Close()
    End Sub

    Private Sub AC13A_Button_Valider_Click(sender As System.Object, e As System.EventArgs) Handles AC13A_Button_Valider.Click
        'Récupère le lieu que l'utilisateur entre
        Dim monLieu As String
        monLieu = Me.AC13A_ComboBox_Lieu.SelectedValue
        MsgBox(monLieu)

        'Récupère la première date que l'utilisateur entre
        Dim monRDV As String
        monRDV = Me.AC13A_DateTimePicker_RDV.Value.ToString()

        'Récupère la seconde date que l'utilisateur entre
        Dim monRDV2 As String
        monRDV2 = Me.AC13A_DateTimePicker_RDV2.Value.ToString()

        'Récupère la date à laquelle l'utilisateur ajoute l'étape
        Dim maPEC As String
        maPEC = Me.AC13A_DateTimePicker_PEC.Value.ToString()

        'Récupère le commentaire de l'utilisateur
        Dim monCommentaire As String
        monCommentaire = Me.AC13A_RichTextBox_Commentaire.Text
        Dim requete As String = "INSERT INTO ETAPE(TRNNUM, LIEUID, ETPHREDEBUT, ETPHREFIN, ETPCOMMENTAIRE) VALUES (" & TRNNUM & ",'" & monLieu & "',TO_DATE('" & monRDV & "', 'DD/MM/YYYY HH24:MI:SS'),TO_DATE('" & monRDV2 & "', 'DD/MM/YYYY HH24:MI:SS'),'" & monCommentaire & "');"
